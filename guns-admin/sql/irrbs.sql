...
-- 表编号:101
DROP TABLE
IF EXISTS `Irrb_s_base`;

CREATE TABLE `Irrb_s_base` (
  `irr_code` CHAR (7) NOT NULL COMMENT '灌区编码',
  `irr_name` VARCHAR (50) COMMENT '灌区名称',
  `irr_type` CHAR (1) COMMENT '灌区类型 1:水库 2:河流 3:井 9:其他',
  ...
  PRIMARY KEY (`SourceE_Code`)
) ENGINE = INNODB DEFAULT CHARSET = utf8 COMMENT = '灌区信息表';
...
-- 表编号:101
DROP TABLE
IF EXISTS `IrrBFSource`;

CREATE TABLE `IrrBFSource` (
  `SourceE_Code` CHAR (11) NOT NULL COMMENT '水源工程编码',
  `SourceE_Name` VARCHAR (50) COMMENT '水源工程名称',
  `SourceE_Type` CHAR (1) COMMENT '水源工程类型 1:水库 2:河流 3:井 9:其他',
  `Source_Type` CHAR (1) COMMENT '水源类型 1:地表水 2:地下水 9:其他',
  PRIMARY KEY (`SourceE_Code`)
) ENGINE = INNODB DEFAULT CHARSET = utf8 COMMENT = '水源信息表';
